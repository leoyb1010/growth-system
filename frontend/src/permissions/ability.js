...
const ROLE_PERMISSIONS = {
  super_admin: [
    ...
    'import.excel', 'export.data', 'search.use', 'agent.use', 'agent.admin',
  ...
  cps_admin: ['cps.read', 'cps.write', 'cps.admin', 'agent.use'],
  cps_ops: ['cps.read', 'cps.write', 'agent.use'],
  cps_channel_user: ['cps.read', 'cps.channel_upload', 'cps.channel_read_own', 'agent.use'],
  aso_admin: ['aso.read', 'aso.write', 'aso.admin', 'agent.use'],
  aso_ops: ['aso.read', 'aso.write', 'agent.use'],
  aso_viewer: ['aso.read', 'agent.use'],
  supervisor: [
    ...
    'export.data', 'search.use', 'agent.use', 'cps.read', 'aso.read', 'action_item.read', 'risk_register.read',
    'user.read'
  ],
  department_manager: [
    ...
    'weekly_report.read', 'weekly_report.generate', 'weekly_report.update',
    'export.data', 'search.use', 'agent.use',
    'action_item.read', 'action_item.create', 'action_item.update', 'action_item.delete',
    'risk_register.read', 'risk_register.create', 'risk_register.update'
  ],
  department_member: [
